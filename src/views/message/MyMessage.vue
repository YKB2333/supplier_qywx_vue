            ...
            >
              ...
              <ul class="messageList">
                ...
                <!-- 
                 ...
                 -->
                  <!-- 最后回复未读 -->
                  <template v-if="item.lastNotice && !item.lastNotice.readStatus">
                    <div :class="{'newNews':true}">
                  ...
                  <div>
                    ...
                    <p class=" ellipsis1" style="color: #959ca7;font-size: 12px;">{{item.sendUserName}}</p>
        ...
        .then(async res => {
          if (this.isEmpty(res.list)) {
            ...
            for (let item of res.list) {
              ...
              //     item.avatar = this.wxUserCache[
              //       item.lastNotice.sendUserId
              //     ].avatar
              //     item.sendUserName = this.wxUserCache[
              //       item.lastNotice.sendUserId
              //     ].name
              //   } else {
